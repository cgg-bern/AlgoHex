...
// Corresponding .cc file generated using GNU Octave and
// https://gitlab.inf.unibe.ch/mheistermann/matlab-matrix-to-cxx-source

//extern Eigen::Matrix<double, 16, 100> sdpA;
extern Eigen::Matrix<double, 16, 1> sdpB;

static double data[1600] = {0x1.0000000000000p+0, 0x0.0p+0, 0x0.0p+0, 0x0.0p+0, 0x0.0p+0, 0x0.0p+0, 0x0.0p+0, 0x0.0p+0,
...
Eigen::Map<Eigen::Matrix<double, 16, 100> > sdpA(data);
